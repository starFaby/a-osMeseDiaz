...
function fechaNacimiento(){
 ...
 function fechaN(birthdate) {
    ...
    dd = fechaActual.getDate();
    yyyy = fechaActual.getFullYear();
    haveMonth = Math.abs(mm - mmNacimiento);
    haveDate = Math.abs(dd - ddNacimiento);
    haveYear = Math.abs(yyyy - yyyyNacimiento);
    showFecha = `Tienes ${haveYear} años, ${haveMonth} meses y ${haveDate} dias`;
